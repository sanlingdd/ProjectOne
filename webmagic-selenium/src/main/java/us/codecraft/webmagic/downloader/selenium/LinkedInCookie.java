...
public class LinkedInCookie implements Serializable {
	  private static final long serialVersionUID = 4115876353625612363L;
	   ...
	   */
	  public LinkedInCookie(String name, String value, String path, Date expiry) {
	   ...
	   */
	  public LinkedInCookie(String name, String value, String domain, String path, Date expiry) {
	   ...
	   */
	  public LinkedInCookie(String name, String value) {
	   ...
	   */
	  public LinkedInCookie(String name, String value, String path) {
