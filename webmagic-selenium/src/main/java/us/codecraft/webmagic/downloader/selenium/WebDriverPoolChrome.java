...
class WebDriverPoolChrome {
	...
	public void configure() throws IOException {
		...
		System.getProperties().setProperty("webdriver.chrome.driver", "/Users/i071944/chromedriver/chromedriver.exe");
		...
		// sCaps.setCapability("chrome.switches",
		// Arrays.asList("--user-data-dir=/Users/i071944/temp/chrome"));
		//
		...
		// "/Users/i071944/chromedriver/chromedriver.exe");
		// } else {
		...
		// mDriver.get("http://www.linkedin.com");
		//
		// WebElement webEmailElement =
		// mDriver.findElement(By.xpath("//input[@id='login-email']"));
		// webEmailElement.sendKeys("huangxianbin_2005@aliyun.com");
		//
		// WebElement webPasswordElement =
		// mDriver.findElement(By.xpath("//input[@id='login-password']"));
		// webPasswordElement.sendKeys("pa22word");
		//
		// WebElement webSubmitElement =
		// mDriver.findElement(By.xpath("//input[@id='login-submit']"));
		// webSubmitElement.submit();
		// }
	}
	...
	public WebDriverPoolChrome(int capacity) {
		this.capacity = capacity;
	}

	public WebDriverPoolChrome() {
