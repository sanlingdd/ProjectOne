...
//		}
		...
		Collections.sort(orderList, (final HuntingCompany firm1, final HuntingCompany firm2) -> firm1.getCode().compareTo(firm2.getCode()));

		mapper.writeValue(new File("C://temp/huntingfirmsPureCode.txt"), huntingFirms);
