...
public class CompanyMessageSendingYuliaNingbo {
...
//				}
				...
				String hintMessage[] = { "Hi " + name + ",\r\n" + "我是connectus的HR，我们在招聘猎头leader、MC、SC、C、AC等级别。\r\n"
						+ "可以加个微信认识一下嘛？我的微信&电话:13774278832" 
						};
				// obj.sleep(1000);
...
//				continue;
//			}
		String company = "https://www.linkedin.com/search/results/people/?geoUrn=%5B%22107930245%22%5D&network=%5B%22F%22%5D&origin=FACETED_SEARCH&page=1";
