...
public class NewCompanyEmployeeDaisy {
		...
		while (true) {
			...
			try {
				...
				if (!sendbuttons.isEmpty()) {
					...
					String hintMessage = "";
					if (!firm.isCustomer()) {
						hintMessage = "您好，我是猎头daisy，\r\n"
								+ "这边有个国内大型高新技术企业中高级嵌入式软件开发的职位想推荐给您，\r\n"
								+ "方便留个联系方式简单沟通下吗？我的电话是：15800652770，\r\n"
								+ "Wechat：esy12345，期待您的回复^ ^";	
					} else {
	...
	public static void main(String[] args)
		...
		File huntingFirmFile = new File("C://temp/DaisyPureURL.txt");
		...
		File cookieFile = new File("C://temp/DaisyCookie.txt");
